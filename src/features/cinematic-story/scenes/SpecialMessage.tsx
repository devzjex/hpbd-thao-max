...
export const SpecialMessage = () => {
    ...
    const defaultWords = isVietnamese
        ? ['Chúc', addr('{ban}'), 'một', 'ngày', 'thật', 'tuyệt', 'vời!']
        : isFrench
    ...
    const salutation = isVietnamese
        ? (relationship === 'partner'
            ? (isMale ? 'Gửi chàng trai của em,' : isFemale ? 'Gửi cô gái của anh,' : 'Gửi cả thế giới của tôi,')
            : relationship === 'friend'
                ? (isMale ? 'Gửi người anh em huyền thoại,' : isFemale ? 'Gửi cô bạn thân yêu quý,' : 'Gửi người bạn thân nhất,')
                : `Gửi ${name || 'bạn'},`)
        : isFrench
        ? (relationship === 'partner'
