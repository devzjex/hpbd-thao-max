...
const Index = () => {
    ...
    return (<main aria-label={isVietnamese ? "Trải nghiệm chúc mừng sinh nhật" : "Birthday Celebration Experience"} className="min-h-screen transition-colors duration-1000 relative overflow-hidden" style={{ background: 'var(--bg-gradient, #1a0515)' }}>
