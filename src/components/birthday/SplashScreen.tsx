...
export const SplashScreen = ({ onStart }: SplashScreenProps) => {
    ...
    return (
        ...
        >
            ...
            <h1 className="sr-only">{isVietnamese ? "Birthday Bloom — Website chúc mừng sinh nhật đậm chất điện ảnh" : "Birthday Bloom — Magical Cinematic Birthday Celebration"}</h1>
