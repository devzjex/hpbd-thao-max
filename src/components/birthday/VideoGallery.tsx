...
export const VideoGallery = () => {
    ...
    return (
        <section className="relative z-20 px-4 py-24 sm:py-32 max-w-7xl mx-auto overflow-hidden" aria-label={isVietnamese ? "Thư viện video kỷ niệm đặc biệt" : "Special Video Memories Gallery"}>
            <motion.div
            ...
            >
                ...
                <p className="font-display italic text-lg sm:text-xl md:text-2xl text-foreground/70 max-w-2xl mx-auto">
                    {relationship === "partner"
                        ? isVietnamese
                            ? addr("“Từng giây bên {ban} đều đẹp như một thước phim.”")
                            : isFrench
                        ...
                        : relationship === "friend"
                            ? isVietnamese
                                ? "“Mừng cho mọi chuyến phiêu lưu điên rồ và những tràng cười khó quên!”"
                                : isFrench
                            ...
                            : isVietnamese
                                ? "“Những khoảnh khắc bên gia đình là kho báu quý giá nhất.”"
                                : isFrench
            ...
            {validVideos.length > 0 ? (
                ...
                >
                    ...
                    >
                        {relationship === "partner"
                            ? isVietnamese
                                ? "Cùng nhau tạo nên những kỷ niệm đẹp nhất nhé ✨"
                                : isFrench
                            ...
                            : relationship === "friend"
                                ? isVietnamese
                                ? "Sẵn sàng cho những kỷ niệm huyền thoại tiếp theo chưa? 🔥"
                                : isFrench
                                ...
                                : isVietnamese
                                    ? "Còn nhiều khoảnh khắc quý giá đang chờ phía trước 🌟"
                                    : isFrench
                    ...
                    <p className="font-display font-light text-lg sm:text-2xl text-white/85 max-w-xl mx-auto leading-relaxed mb-8">
                        {relationship === "partner"
                            ? isVietnamese
                                ? addr("Chúng ta chưa kịp quay hết những thước phim... nhưng trái tim này vẫn đang chờ cả một đời những chuyến phiêu lưu đẹp đẽ bên {ban}! 💖")
                                : isFrench
                            ...
                            : relationship === "friend"
                                ? isVietnamese
                                    ? "Chưa có video nào được tải lên... nhưng thôi nào, sắp tới mình sẽ cùng tạo ra những kỷ niệm điên rồ và khó quên! 🎉🍻"
                                    : isFrench
                                ...
                                : isVietnamese
                                    ? "Mỗi khoảnh khắc bên gia đình đều là một món quà. Mong sẽ còn lưu giữ thêm thật nhiều kỷ niệm đẹp cùng nhau! 🌟"
                                    : isFrench
