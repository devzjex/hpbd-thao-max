...
export const FinalSurprise = () => {
    ...
    return (<section className="relative z-20 py-32 px-4 overflow-hidden" aria-label={isVietnamese ? "Bất ngờ cuối cùng và những kỷ niệm" : "Final Surprise and Memories"}>
      <div className="max-w-6xl mx-auto">
        ...
        {hasValidVideo && (<motion.div initial={{ opacity: 0, scale: isMobile ? 1 : 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className={isMobile ? "relative max-w-4xl mx-auto rounded-[2rem] overflow-hidden border border-white/20 shadow-[0_0_80px_-20px_var(--color-primary)] bg-black/70 backdrop-blur-xl" : "relative max-w-4xl mx-auto rounded-[3rem] overflow-hidden border border-white/20 shadow-[0_0_100px_-20px_var(--color-primary)] bg-black/40 backdrop-blur-3xl"}>
            ...
            <div className="p-10 text-center bg-gradient-to-t from-black/80 to-transparent">
              <h3 className="font-display text-2xl md:text-4xl font-black mb-4">{isVietnamese ? "Bất Ngờ Cuối Cùng 🎬" : isFrench ? "L'Ultime Surprise 🎬" : isBengali ? "শেষ সারপ্রাইজ 🎬" : isHindi ? "आखरी सरप्राइज 🎬" : "The Final Surprise 🎬"}</h3>
              <p className="text-lg md:text-xl text-white/60 font-light">{isVietnamese ? addr("Một chút quà nho nhỏ để trái tim {ban} mỉm cười.") : isFrench ? "Une petite touche spéciale pour illuminer votre cœur et faire sourire votre âme." : isBengali ? "আপনার মুখে একটি মিষ্টি হাসি ফুটিয়ে তোলার জন্য একটি ছোট্ট উপহার।" : isHindi ? "आपके चेहरे पर एक प्यारी सी मुस्कान लाने के लिए एक छोटा सा तोहफा।" : "A little something extra to make your heart smile."}</p>
            </div>
          </motion.div>)}
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="mt-40 text-center space-y-12 pb-40">
          ...
          <div className="space-y-6">
            <h2 className="font-display text-4xl md:text-7xl font-black tracking-tight leading-tight">
              {isVietnamese ? addr("Mong điều này khiến ngày của {ban} ") : isFrench ? "J'espère que cette journée a été " : isBengali ? "আশা করি এটি আপনার দিনটিকে " : isHindi ? "उम्मीद है यह आपके दिन को " : "I Hope This Made Your "} <br />
              <span style={{ color: primaryColor }} className="animate-pulse">{isVietnamese ? addr("thật đặc biệt, đúng như chính {ban} vậy") : isFrench ? "aussi spéciale et merveilleuse que vous l'êtes" : isBengali ? "আপনার মতোই সুন্দর ও বিশেষ করে তুলবে" : isHindi ? "उतना ही खास बनाएगा जितने आप हैं" : "Day As Special As You Are"}</span>
            </h2>
            <p className="text-xl md:text-3xl font-light text-foreground/60 max-w-3xl mx-auto leading-relaxed">
              {isVietnamese ? "Từng điểm ảnh, từng chuyển động và từng con chữ đều được làm bằng cả tấm lòng." : isFrench ? "Chaque pixel, chaque animation et chaque mot a \u00E9t\u00E9 con\u00E7u avec tout notre amour." : isBengali ? "\u09AA\u09CD\u09B0\u09A4\u09BF\u099F\u09BF \u09AA\u09BF\u0995\u09CD\u09B8\u09C7\u09B2, \u09AA\u09CD\u09B0\u09A4\u09BF\u099F\u09BF \u0985\u09CD\u09AF\u09BE\u09A8\u09BF\u09AE\u09C7\u09B6\u09A8 \u098F\u09AC\u0982 \u09AA\u09CD\u09B0\u09A4\u09BF\u099F\u09BF \u09B6\u09AC\u09CD\u09A6 \u09B6\u09C1\u09A7\u09C1 \u09A8\u09BF\u0996\u09BE\u09A6 \u09AD\u09BE\u09B2\u09CB\u09AC\u09BE\u09B8\u09BE \u09A6\u09BF\u09AF\u09BC\u09C7 \u09A4\u09C8\u09B0\u09BF\u0964" : isHindi ? "\u09B9\u09B0 \u090F\u0915 \u09AA\u09BF\u0915\u09CD\u09B8\u09C7\u09B2, \u09B9\u09B0 \u090F\u09A8\u09BF\u09AE\u09C7\u09B6\u09A8 \u0914\u09B0 \u09B9\u09B0 \u09B6\u09AC\u09CD\u09A6 \u09B8\u09BF\u09B0\u09CD\u092B \u0914\u09B0 \u09B8\u09BF\u09B0\u09CD\u092B \u09AA\u09CD\u09AF\u09BE\u09B0 \u09B8\u09C7 \u09B8\u099C\u09BE\u09AF\u09BE \u0917\u09AF\u09BE \u09B9\u0948\u0964" : "Every pixel, every animation, and every word was crafted with love."} <br />
              {isVietnamese ? `Một lần nữa, chúc mừng sinh nhật ${config.name}. \u2728` : isFrench ? `Encore une fois, tr\u00E8s Joyeux Anniversaire, ${config.name}. \u2728` : isBengali ? `\u0986\u09B0\u0993 \u098F\u0995\u09AC\u09BE\u09B0 \u099C\u09A8\u09CD\u09AE\u09A6\u09BF\u09A8\u09C7\u09B0 \u0985\u09AB\u09C1\u09B0\u09A8\u09CD\u09A4 \u09B6\u09C1\u09AD\u09C7\u099A\u09CD\u099B\u09BE, ${config.name}\u0964 \u2728` : isHindi ? `\u090F\u0915 \u09AC\u09BE\u09B0 \u09AB\u09BF\u09B0 \u099C\u09A8\u09CD\u09AE\u09A6\u09BF\u09A8 \u0915\u0940 \u09A2\u09C7\u09B0 \u09B8\u09BE\u09B0\u0940 \u09B6\u09C1\u09AD\u0915\u09BE\u09AE\u09A8\u09BE\u090F\u0902, ${config.name}\u0964 \u2728` : `Happy Birthday once again, ${config.name}. \u2728`}
            </p>
          </div>
