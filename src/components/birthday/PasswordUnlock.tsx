    ...
    const getDynamicHint = () => {
        ...
        if (isVietnamese) {
            switch (format.toUpperCase()) {
                case 'MMDD':
                    return "Gợi ý: Ngày đặc biệt của hôm nay (Định dạng: MMDD, ví dụ 0424 cho ngày 24 tháng 4) 📅";
                case 'DDMM':
                    return "Gợi ý: Ngày đặc biệt của hôm nay (Định dạng: DDMM, ví dụ 2404 cho ngày 24 tháng 4) 📅";
                case 'YYYYMMDD':
                    return "Gợi ý: Ngày sinh đầy đủ kèm năm (Định dạng: YYYYMMDD, ví dụ 20010424) 📅";
                case 'YYYY-MM-DD':
                    return "Gợi ý: Ngày sinh đầy đủ (Định dạng: YYYY-MM-DD, ví dụ 2001-04-24) 📅";
                case 'MM-DD':
                    return "Gợi ý: Tháng và ngày sinh (Định dạng: MM-DD, ví dụ 04-24) 📅";
                case 'DD-MM':
                    return "Gợi ý: Ngày và tháng sinh (Định dạng: DD-MM, ví dụ 24-04) 📅";
                case 'YYYY':
                    return "Gợi ý: Năm sinh (Định dạng: YYYY, ví dụ 2001) 📅";
                default:
                    return "Gợi ý: Chính là ngày đặc biệt mà hôm nay chúng ta đang mừng! 🎂";
            }
        }
        if (isFrench) {
            switch (format.toUpperCase()) {
