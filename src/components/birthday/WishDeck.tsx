...
const WishCard = ({
    ...
    const { addr, isVietnamese } = useTranslation();
                        ...
                        {isBlankCard ? (
                            <div className="text-center w-full">
                                ...
                                <p className="font-handwritten text-xl sm:text-2xl text-[#8B7355] italic">
                                    {isVietnamese ? addr("Tự viết lời chúc của {ban}...") : "Write your own wish..."}
                                </p>
                            </div>
                        ) : (
...
export const WishDeck = () => {
    ...
    const deck = useMemo(() => {
        const templates = getWishDeck(relationship, name, language);
        return [...templates, { ...WRITE_YOUR_OWN_CARD, text: "" }];
    }, [relationship, name, language]);
    ...
    // Heading text
    const heading = isVietnamese
        ? addr("Những lời chúc dành cho {ban} ✨")
        : isBengali
                ...
                <div className="max-w-md mx-auto">
                    ...
                    <div className="flex items-center justify-center gap-6">
                        <button
                            ...
                            aria-label={isVietnamese ? "Bỏ qua lời chúc này" : "Skip this wish"}
                        >
                            <X size={24} />
                        </button>
                        ...
                        <button
                            ...
                            aria-label={isVietnamese ? "Chọn lời chúc này" : "Select this wish"}
                        >
            ...
            {phase === "confirming" && selectedWish && (
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 items-center justify-center">
                        ...
                        >
                            <Send size={18} /> {isVietnamese ? "Dùng lời chúc này" : "Use This Wish"}
                        </button>
                        <button
                            type="button"
                        ...
                        >
                            <Pencil size={16} /> {isVietnamese ? "Chỉnh sửa lại" : "Customize It"}
                        </button>
                        <button
                            type="button"
                        ...
                        >
                            {isVietnamese ? "← Quay lại bộ thiệp" : "← Back to deck"}
                        </button>
                    </div>
                </motion.div>
            )}
            ...
            {phase === "customizing" && (
                ...
                >
                    ...
                    >
                        ...
                        <div className="relative z-10 p-7 sm:p-9">
                            ...
                            <textarea
                                ...
                                placeholder={isVietnamese ? `Viết lời chúc sinh nhật cho ${name}...` : `Write a birthday wish for ${name}...`}
                    ...
                    <div className="flex flex-col items-center gap-3">
                        ...
                        >
                            <Send size={18} /> {isVietnamese ? "Gửi đi khắp thế gian" : "Send to the World"}
                        </button>
                        <button
                            type="button"
                            onClick={() => {
            ...
            {phase === "done" && (
                ...
                >
                    ...
                    <h3 className="text-3xl sm:text-4xl font-display font-black text-white mb-4">
                        {isVietnamese ? "Đã gửi lời chúc!" : isBengali ? "শুভকামনা পাঠানো হয়েছে!" : isHindi ? "शुभकामना भेज दी गई!" : isFrench ? "Vœu envoyé !" : "Wish Sent!"}
                    </h3>
                    <p className="text-white/50 text-lg mb-8 max-w-xs mx-auto">
                        {isVietnamese
                            ? addr("Yêu thương của {ban} đã lan toả khắp vũ trụ ✨")
                            : isBengali
                    ...
                    >
                        <RotateCcw size={14} /> {isVietnamese ? "Xem lại bộ thiệp" : "Browse Again"}
                    </button>
                </motion.div>
            )}
        </section>
