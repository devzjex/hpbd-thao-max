...
export const getCakeName = (cake: CakeOption, isHindi?: boolean, isBengali?: boolean, isFrench?: boolean, isVietnamese?: boolean): string => {
    if (isVietnamese && cake.nameVi) return cake.nameVi;
