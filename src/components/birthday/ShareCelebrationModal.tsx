...
export const ShareCelebrationModal: React.FC<ShareCelebrationModalProps> = ({ isOpen, onClose }) => {
  ...
  const { language, addr, isBengali, isHindi, isFrench, isVietnamese } = useTranslation();
  ...
  const shareText = targetName
    ? (isVietnamese
        ? `✨ Cùng chúc mừng sinh nhật ${targetName} với một bất ngờ thật đặc biệt trên Birthday Bloom nhé! 🎂🎉`
        : isFrench 
    ...
    : (isVietnamese
        ? `✨ Xem thử trải nghiệm chúc mừng sinh nhật đậm chất điện ảnh trên Birthday Bloom! 🎂🎉`
        : isFrench
        ...
        >
          ...
          <div className="text-center mb-6">
            ...
            <h3 id="share-modal-title" className="font-display text-2xl sm:text-3xl font-black text-white">
              {isVietnamese ? "Chia sẻ buổi tiệc ✨" : isFrench ? "Partager la Célébration ✨" : isBengali ? "উদযাপন শেয়ার করুন ✨" : isHindi ? "जश्न शेयर करें ✨" : "Share Celebration ✨"}
            </h3>
            <p className="text-white/60 text-xs sm:text-sm mt-1">
              {isVietnamese
                ? addr("Gửi bất ngờ này đi hoặc tạo một đường dẫn riêng cho người đặc biệt của {ban}")
                : isFrench 
          ...
          <div className="flex rounded-xl bg-white/5 p-1 mb-6 border border-white/10">
            ...
            >
              <Send size={14} />
              {isVietnamese ? "Chia sẻ ngay" : isFrench ? "Partager Maintenant" : isBengali ? "এখনই শেয়ার করুন" : isHindi ? "अभी शेयर करें" : "Quick Share"}
            </button>
            <button
              type="button"
            ...
            >
              <Sparkles size={14} />
              {isVietnamese ? "Tạo cho người khác" : isFrench ? "Créer pour Quelqu'un" : isBengali ? "নতুন তৈরি করুন" : isHindi ? "नया बनाएं" : "Customize Surprise"}
            </button>
          </div>
            ...
            <div className="space-y-4 mb-6 text-left">
              <div>
                <label className="block text-xs font-semibold uppercase tracking-wider text-white/70 mb-1.5">
                  {isVietnamese ? "Tên người nhận" : isFrench ? "Nom du Destinataire" : isBengali ? "যার জন্মদিন (নাম)" : isHindi ? "जिसका जन्मदिन है (नाम)" : "Recipient Name"}
                </label>
                <input
                  type="text"
                  value={customName}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-semibold uppercase tracking-wider text-white/70 mb-1.5">
                    {isVietnamese ? "Mối quan hệ" : isFrench ? "Relation" : isBengali ? "সম্পর্ক" : isHindi ? "रिश्ता" : "Relationship"}
                  </label>
                  <select
                    value={customRel}
                ...
                <div>
                  <label className="block text-xs font-semibold uppercase tracking-wider text-white/70 mb-1.5">
                    {isVietnamese ? "Ngôn ngữ" : isFrench ? "Langue" : isBengali ? "ভাষা" : isHindi ? "भाषा" : "Language"}
                  </label>
                  <select
                    value={customLang}
              ...
              <div>
                <label className="block text-xs font-semibold uppercase tracking-wider text-white/70 mb-1.5">
                  {isVietnamese ? "Tên bạn (người gửi)" : isFrench ? "Votre Nom (Expéditeur)" : isBengali ? "আপনার নাম (শুভেচ্ছক)" : isHindi ? "आपका नाम (शुभचिंतक)" : "Your Name (Optional)"}
                </label>
                <input
                  type="text"
                  value={customSender}
          ...
          <div className="grid grid-cols-3 sm:grid-cols-5 gap-2.5 mb-6">
            <button
              ...
              aria-label={isVietnamese ? "Chia sẻ qua WhatsApp" : "Share via WhatsApp"}
            ...
            <button
              ...
              aria-label={isVietnamese ? "Chia sẻ qua X / Twitter" : "Share via X / Twitter"}
            ...
            <button
              ...
              aria-label={isVietnamese ? "Chia sẻ qua Telegram" : "Share via Telegram"}
            ...
            <button
              ...
              aria-label={isVietnamese ? "Chia sẻ qua Facebook" : "Share via Facebook"}
            ...
            <button
              ...
              aria-label={isVietnamese ? "Chia sẻ qua LinkedIn" : "Share via LinkedIn"}
          ...
          <div className="flex items-center gap-2 rounded-2xl border border-white/15 bg-white/5 p-2 mb-4">
            <input
              type="text"
              readOnly
              aria-label={isVietnamese ? "Đường dẫn chia sẻ" : "Celebration Share URL"}
            ...
            <button
              ...
              aria-label={isVietnamese ? "Sao chép đường dẫn" : "Copy share link"}
          ...
          {typeof navigator !== 'undefined' && 'share' in navigator && (
            ...
            >
              <Share2 size={16} />
              {isVietnamese ? "Chia sẻ qua ứng dụng khác" : isFrench ? "Partager via les Applications" : isBengali ? "অন্যান্য অ্যাপে শেয়ার করুন" : isHindi ? "अन्य ऐप्स में शेयर करें" : "More Sharing Options"}
            </button>
          )}
